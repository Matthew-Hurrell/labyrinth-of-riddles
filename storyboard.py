...
intro_paragraph = """
    ...
    But beware! Many brave explorers who venture into the labyrinth
    never return.
...
left = """
    ...
    You turn right at the end of the path and right again as it curves
    around onto itself.
...
second_left = """
    ...
    Against your better judgement you decide to ignore the words of
    warning and go left anyway.

    You follow the pathway forwards and then around to the left.

    You begin to notice small holes in the ceiling and walls as you
    continue to walk forwards.

    As you walk further into the passageway, you hear an audible click as
    one of your feet touches a panel on the floor.
...
right = """
    ...
    The words read: "The answer to the Riddlers next riddle is a six
    letter word beginning with S. You're welcome."
...
which_question = """
    ...
    Question C: Ask figure one - Which door would the other figure
    tell me leads to death?

    Question D: Ask figure two - Which door would the other figure
    tell me leads to death?
...
path_six = """
    ...
    "You may ask us one question and then you must make a choice on
    which door to open."
...
right_door_choice = """
    ...
    You peak around the door and see a pathway that continues and
    turns left around a corner.

    You breathe a sigh of relief and pass through the door, closing it
    behind you.

    You follow the path around to the left and see some words written on
...
left_descent = """
    ...
    Behind you you see a wall that looks slightly different from the
    other walls.
